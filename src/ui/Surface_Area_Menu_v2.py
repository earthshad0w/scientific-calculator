...
def run_surface_area_menu():
    ...
    "Press 5 for the lateral area of a regular pyramid.\n"
    "Press 6 for the surface area of a regular pyramid.\n"
    "Press 7 for the lateral area of a cone.\n"
    "Press 8 for the surface area of a cone.\n"
    "Press 9 for the surface area of a sphere.\n"
    "Press 10 for the lateral area of a frustum.\n"
    "Press 11 for the surface area of a frustum.\n"
)
    ...
    if function_choice == 1:
        ...
        lateral_area = area_functions.lateral_area_of_frustum()
        print(f"The lateral area of the frustum is {lateral_area} square units.")
     
    elif function_choice == 11:
        surface_area = area_functions.surface_area_of_frustum()
